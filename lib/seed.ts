...
export function buildInitialState() {
  return {
    ...
    cartDiscount: null as import("./types").CartDiscount | null,
    splitPayments: [] as import("./types").SplitPaymentLine[],
    ...
    pendingSync: [
      ...
      },
      {
        ...
        description: "Thanh toán #1041",
        status: "pending" as const,
        time: "10:27",
      },
    ] satisfies import("./types").PendingSyncItem[],
    heldOrders: [] as { id: string; savedAt: string; cart: import("./types").CartItem[]; discount: import("./types").CartDiscount | null; customerName: string }[],
